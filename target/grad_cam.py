    ...
    with tf.Graph().as_default():
        ...
        with tf.Session() as sess:
            ...
            for line in File:
                ...
                output, grads_val, one_hot1 = sess.run([conv_layer, norm_grads, one_hot], feed_dict={img: img_origin, y: [targeted_label]})
                ...
                new_image = np.where(cam3 > np.mean(cam3) / 1.0, image_origin, image)
